...
public class DataPathChooser extends ListActivity {
    private static /* synthetic */ int[] $SWITCH_TABLE$com$filebrowser$DataPathChooser$DISPLAYMODE;
    ...
    private String returnIntent = "com.filebrowser.DataPathChooser";
    ...
    static /* synthetic */ int[] $SWITCH_TABLE$com$filebrowser$DataPathChooser$DISPLAYMODE() {
        int[] iArr = $SWITCH_TABLE$com$filebrowser$DataPathChooser$DISPLAYMODE;
        if (iArr == null) {
            ...
            $SWITCH_TABLE$com$filebrowser$DataPathChooser$DISPLAYMODE = iArr;
        }
        return iArr;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (itemId == R.id.menuCancel) {
            ...
            if (!this.returnIntent.contentEquals("back")) {
                new Intent(this.returnIntent).putExtra("directory", this.currentDirectory.getPath());
            }
            finish();
        }
        return false;
    ...
    private void fill(File[] files) {
        ...
        switch ($SWITCH_TABLE$com$filebrowser$DataPathChooser$DISPLAYMODE()[this.displayMode.ordinal()]) {
            case 1:
